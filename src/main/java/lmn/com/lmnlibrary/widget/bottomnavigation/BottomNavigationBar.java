package lmn.com.lmnlibrary.widget.bottomnavigation;
...
import lmn.com.lmnlibrary.widget.bottomnavigation.behaviour.BottomNavBarFabBehaviour;
import lmn.com.lmnlibrary.widget.bottomnavigation.behaviour.BottomVerticalScrollBehavior;
import lmn.com.lmnlibrary.widget.bottomnavigation.utils.Utils;
...
public class BottomNavigationBar extends FrameLayout {
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mActiveColor = typedArray.getColor(R.styleable.BottomNavigationBar_bnbActiveColor, Utils.fetchContextColor(context, R.attr.bnbActiveColor));
            ...
            mActiveColor = Utils.fetchContextColor(context, R.attr.bnbActiveColor);
