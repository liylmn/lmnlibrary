...
import lmn.com.lmnlibrary.utils.NavigationBarUtil;
...
public abstract class BaseActivity extends AppCompatActivity implements UiCallback{
    ...
    protected void showProgressDialog(String msg , DialogInterface.OnCancelListener listener){
        if(loadingDialog == null){
            ...
            //失能焦点
            NavigationBarUtil.focusNotAle(loadingDialog.getWindow());
            loadingDialog.show();
            //显示虚拟栏的时候 隐藏
            NavigationBarUtil.hideNavigationBar(loadingDialog.getWindow());

            //再清理失能焦点
            NavigationBarUtil.clearFocusNotAle(loadingDialog.getWindow());
        }
